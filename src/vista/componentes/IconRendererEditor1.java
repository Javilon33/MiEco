 ...
 */
public class IconRendererEditor1 extends AbstractCellEditor implements TableCellRenderer, TableCellEditor {

    private final JLabel labelIcon;
    private int selectedRow;

    public IconRendererEditor1(JTable table, ControladorCuentas controlador) {
